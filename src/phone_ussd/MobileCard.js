...
export default class MobileCard extends React.Component{
    ...
    async _alert(){
            ...
            RNImmediatePhoneCall.immediatePhoneCall(`*901*${this.state.pincode}*2*1*1*1*${this.state.amount}*1#`);
    }
    closeModal() {
        this.setState({ check: false})
        this.props.closeMobleCard()
    }
        ...
        return(
          ...
          >
            <View style = {styles.modal}>
              <Text style={styles.header}>Recharge your mobile airtime from mobile account</Text>
